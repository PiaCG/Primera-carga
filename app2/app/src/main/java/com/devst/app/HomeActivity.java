...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAbrirWeb.setOnClickListener(v -> {
            Uri uri = Uri.parse("https://www.playstation.com/es-cl/ps5/games/");
        ...
        btnEnviarCorreo.setOnClickListener(v -> {
            ...
            email.putExtra(Intent.EXTRA_SUBJECT, "Evaluacion app2");
            email.putExtra(Intent.EXTRA_TEXT, "Hola, Profe esperando que se encuentre bien le presento mi app😁.");
        ...
        btnCompartir.setOnClickListener(v -> {
            ...
            share.putExtra(Intent.EXTRA_TEXT, "Hola Profe, ya po pongame el 7 😎");
        ...
        btnLlamar.setOnClickListener(v -> {
            ...
            share.setData(Uri.parse("tel:946478122"));
            startActivity(share);
        });

        //Evento: Intent implícito → configuraciones
        btnConfig.setOnClickListener(v -> {
            Intent share = new Intent(Settings.ACTION_WIRELESS_SETTINGS);
            startActivity(share);
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.action_perfil) {
            ...
            Toast.makeText(this, "Lanzando sincronizacion", Toast.LENGTH_SHORT).show();
            return true;
